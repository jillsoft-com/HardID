# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------
# Copyright (c) 2026 jillsoft-com (Lijun Jiang). All rights reserved.
# Project: HardID Protocol (Hardware-as-Identity)
# Module: HardID-IM P2P Core Prototype (Alpha v1.0)
# Description: Pure P2P decentralized identity handshake and encrypted chat.
#              No central servers. Hardware is Identity.
